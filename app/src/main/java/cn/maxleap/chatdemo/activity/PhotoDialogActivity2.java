...
import cn.maxleap.chatdemo.entiry.ShuoShuoPhotoEvent;
import cn.maxleap.chatdemo.entiry.ShuoShuoXiangCeEvent;
import cn.maxleap.chatdemo.utils.DeviceInfo;


public class PhotoDialogActivity2 extends Activity implements View.OnClickListener {

    private static final String PATH = "/mnt/sdcard/"+System.currentTimeMillis()+".jpg";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PHOTO && resultCode == Activity.RESULT_OK) {
            ...
            EventBus.getDefault().postSticky(new ShuoShuoPhotoEvent(PATH));
        }
        ...
        if (requestCode == REQUEST_CODE_XIANGCE && resultCode == Activity.RESULT_OK) {
            ...
            if (null != data) {
                ...
                EventBus.getDefault().postSticky(new ShuoShuoXiangCeEvent(picturePath));
